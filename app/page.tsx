        ...
        <Fragment>
            ...
            >
                ...
                <Modal
                    ...
                    backdrop="static"
                    keyboard={false}
                    dialogClassName="modal-blur-backdrop"
                >
                                        ...
                                        <Row className="gy-3">
                                            <Col xl={12}>
                                                ...
                                                <Form.Control
                                                    ...
                                                    value={contactFormData.institutionName}
                        ...
                        <Row className="justify-content-center gy-3">
                            ...
                            <Col sm={3} xl={2} className="col-6">
                                ...
                                <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                    <li>
                                        <Link scroll={false} href="#!" className="text-fixed-white op-6">Servicios</Link>
                                    </li>
                                    <li>
                                        <Link scroll={false} href="#!" className="text-fixed-white op-6">Guías</Link>
                                    </li>
                                    <li>
                                        <Link scroll={false} href="#!" className="text-fixed-white op-6">Integraciones</Link>
                                    </li>
                                    <li>
                                        <Link scroll={false} href="/pages/pricing" className="text-fixed-white op-6">Planes</Link>
                                    </li>
                                </ul>
                            </Col>
                            <Col sm={3} xl={2} className="col-6">
                                ...
                                <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                    ...
                                    <li>
                                        <Link scroll={false} href="#!" className="text-fixed-white op-6">Documentación</Link>
                                    </li>
                                    <li>
                                        <Link scroll={false} href="#!" className="text-fixed-white op-6">Asistentcia</Link>
                                    </li>
                                </ul>
                            </Col>
                            <Col sm={3} xl={2} className="col-6">
                                ...
                                <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                    ...
                                    <li>
                                        <Link scroll={false} href="#!" className="text-fixed-white op-6">Integraciones sociales</Link>
                                    </li>
                                </ul>
                            </Col>
                            <Col sm={3} xl={2} className="col-6">
                                ...
                                <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                    ...
                                    <li>
                                        <Link scroll={false} href="#!" className="text-fixed-white op-6">Trabajos</Link>
                                    </li>
                                </ul>
                            </Col>
                        </Row>
                        ...
                        <Row>
                            ...
                            <Col lg={8} className="text-lg-end text-center mt-lg-0 mt-1">
                                <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                    ...
                                    <li>
                                        <Link scroll={false} href="#!" className="text-fixed-white op-8">Licencias</Link>
                                    </li>
                                </ul>
                            </Col>
                        </Row>
