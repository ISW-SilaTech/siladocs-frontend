                        ...
                        <div className="header-content-left">
                            ...
                            <div className="header-element">
                                <div className="horizontal-logo">
                                    <Link scroll={false} href="/landing" className="header-logo">
                                ...
                                <ul className="main-menu flex-fill justify-content-center">
                                    ...
                                    <li className="slide">
                                        <Link scroll={false} href="#feature" className="side-menu__item">
                                            <span className="side-menu__label">Características</span>
                                        </Link>
                                    </li>
                                    <li className="slide">
                                        <Link scroll={false} href="#service" className="side-menu__item">
                                            <span className="side-menu__label">Servicios</span>
                                        </Link>
                                    </li>
...
`}</style>
                ...
                <div className="main-content landing-main px-0" onClick={handleClick1}>
                                    ...
                                    <div className="tab-style-1 border bg-white rounded-0 d-inline-block">
                                        <Nav className="nav nav-pills" role="tablist">
                                            <Nav.Item className="" role="presentation">
                                                <Nav.Link eventKey={"monthly"} type="button" className="rounded-0 fw-medium" data-bs-toggle="pill" data-bs-target="#pricing1-monthly" aria-selected="true" role="tab">Mensual</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item className="" role="presentation">
                                                <Nav.Link eventKey={"yearly"} type="button" className="rounded-0 fw-medium" data-bs-toggle="pill" data-bs-target="#pricing1-yearly" aria-selected="false" role="tab" tabIndex={-1}>Anual</Nav.Link>
                                            </Nav.Item>
                                        </Nav>
                                    </div>
                                </div>
                    ...
                    <section className="section">
                        <div className="container">
                            <div className="heading-section">
                                ...
                                <div className="heading-title">¿Necesitas ayuda? Encuentra tus respuestas aquí</div>
                                <div className="heading-description">
                                    Consulta las preguntas frecuentes para obtener soluciones rápidas. ¡Estamos aquí para ayudarte!
                                </div>
                            </div>
                            <div className="row">
                    ...
                    <section className="section section-primary testimonials-section">
                        ...
                        <div className="container">
                            <div className="heading-section">
                                <div className="heading-subtitle">Testimonios</div>
                                <div className="heading-title">Mira lo que dicen nuestros clientes</div>
                                <div className="heading-description">
                ...
                <section className="section landing-footer text-fixed-white">
                    <div className="container">
                            ...
                            <Col lg={4}>
                                <div className="form mb-0">
                                    <div className="form-group custom-form-group mx-auto">
                                        <Form.Control type="text" className="shadow-none p-3" placeholder="Ingresa tu correo electrónico..." />
                                        <SpkButton Buttonvariant='primary' Customclass="custom-form-btn btn bg-primary border-0 right-0 shadow-none" Buttontype="button">Suscríbete</SpkButton>
                                    </div>
                                </div>
                            </Col>
                        </Row>
                        <Row className="justify-content-center gy-3">
                            <Col xl={4}>
                                <p className="fw-semibold mb-3 brand-image"><Link scroll={false} href="/landing"><Image fill src="../assets/images/brand-logos/desktop-dark.png" alt="" /></Link></p>
                            ...
                            <Col sm={3} xl={2} className="col-6">
                                ...
                                <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                    <li>
                                        <span className="text-fixed-white op-6" style={{ cursor: 'not-allowed', opacity: 0.6 }}>Servicios</span>
                                    </li>
                                    <li>
                                        <span className="text-fixed-white op-6" style={{ cursor: 'not-allowed', opacity: 0.6 }}>Guías</span>
                                    </li>
                                    <li>
                                        <span className="text-fixed-white op-6" style={{ cursor: 'not-allowed', opacity: 0.6 }}>Integraciones</span>
                                    </li>
                                    <li>
                                        <span className="text-fixed-white op-6" style={{ cursor: 'not-allowed', opacity: 0.6 }}>Planes</span>
                                    </li>
                                </ul>
                            </Col>
                            <Col sm={3} xl={2} className="col-6">
                                ...
                                <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                    ...
                                    <li>
                                        <span className="text-fixed-white op-6" style={{ cursor: 'not-allowed', opacity: 0.6 }}>Soporte técnico</span>
                                    </li>
                                    <li>
                                        <span className="text-fixed-white op-6" style={{ cursor: 'not-allowed', opacity: 0.6 }}>Documentación</span>
                                    </li>
                                    <li>
                                        <span className="text-fixed-white op-6" style={{ cursor: 'not-allowed', opacity: 0.6 }}>Asistentcia</span>
                                    </li>
                                </ul>
                            </Col>
                            <Col sm={3} xl={2} className="col-6">
                                <h6 className="fw-semibold mb-3 text-fixed-white">Otros</h6>
                                <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                    <li>
                                        <span className="text-fixed-white op-6" style={{ cursor: 'not-allowed', opacity: 0.6 }}>Market Place</span>
                                    </li>
                                    <li>
                                        <span className="text-fixed-white op-6" style={{ cursor: 'not-allowed', opacity: 0.6 }}>Integraciones sociales</span>
                                    </li>
                                </ul>
                            </Col>
                            <Col sm={3} xl={2} className="col-6">
                                <h6 className="fw-semibold mb-3 text-fixed-white">Sobre nosotros</h6>
                                <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                    <li>
                                        <span className="text-fixed-white op-6" style={{ cursor: 'not-allowed', opacity: 0.6 }}>Blog</span>
                                    </li>
                                    <li>
                                        <Link scroll={false} href="/sobre-nosotros" className="text-fixed-white op-6">Nosotros</Link>
                                    </li>
                                    <li>
                                        <span className="text-fixed-white op-6" style={{ cursor: 'not-allowed', opacity: 0.6 }}>Clientes</span>
                                    </li>
                                    <li>
                                        <span className="text-fixed-white op-6" style={{ cursor: 'not-allowed', opacity: 0.6 }}>Trabajos</span>
                                    </li>
                                </ul>
                            </Col>
                        </Row>
                        ...
                        <Row className="align-items-center justify-content-center">
                            <Col xl={7} lg={9}>
                                <div className="d-md-flex align-items-center justify-content-center">
                                    <p className="mb-0 me-3 text-fixed-white op-6 fw-normal">Medios de pago :</p>
                                    <div className="d-flex align-items-center gap-2 justify-content-center flex-wrap">
                                        <div className="me-2 mb-2 mb-sm-0 payment-cards" style={{ cursor: 'not-allowed', opacity: 0.6 }}>
                                            <span>
                        ...
                        <Row>
                            <Col lg={4} className="text-lg-start text-center">
                                <span className="text-fixed-white op-7 fs-14"> © Copyright <span id="year"> 2025 </span> <Link scroll={false}
                                    href="#!" className="text-primary fs-15 fw-semibold">Siladocs </Link>. Todos los derechos reservados
                                </span>
                            </Col>
                            <Col lg={8} className="text-lg-end text-center mt-lg-0 mt-1">
                                <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                    ...
                                    <li>
                                        <span className="text-fixed-white op-8" style={{ cursor: 'not-allowed' }}>Legal</span>
                                    </li>
                                    <li>
                                        <Link scroll={false} href="/contacto" className="text-fixed-white op-8">Contáctanos</Link>
                                    </li>
                                    <li>
                                        <span className="text-fixed-white op-8" style={{ cursor: 'not-allowed' }}>Blog</span>
                                    </li>
                                    <li>
                                        <span className="text-fixed-white op-8" style={{ cursor: 'not-allowed' }}>Licencias</span>
                                    </li>
                                </ul>
                            </Col>
                        </Row>
