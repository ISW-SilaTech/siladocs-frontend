                            ...
                            <Card className="custom-card border-0 shadow-none my-4">
                                <Card.Body className="p-5">
                                    <div>
                                        ...
                                        <p className="mb-4 text-muted fw-normal">Ingresa tu nueva contraseña.</p>
                                    </div>
                                    ...
                                    <Row className="row gy-3">
                                            ...
                                            <div className="position-relative">
                                                <Form.Control
                                                    ...
                                                    {...register('newPassword', {
                                                        ...
                                                        minLength: {
                                                            value: 6,
                                                            message: 'Debe incluir al menos 6 caracteres.',
                                                        },
                                                    })}
                                                />
                                        ...
                                        <Col xl={12}>
                                            <label htmlFor="reset-confirmpassword" className="form-label text-default">Confirma contraseña</label>
                                            <div className="position-relative">
                                                <Form.Control
                                    ...
                                    <div className="text-center mt-3 fw-medium">
                                        No deseas restablecerla ? <Link scroll={false} href="/authentication/sign-in/basic/" className="text-primary">Ingresa</Link>
                                    </div>
                                </Card.Body>
                            </Card>
                        </Col>
