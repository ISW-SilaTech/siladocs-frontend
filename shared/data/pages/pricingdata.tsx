...
interface PriceCardData {
    ...
    btnColor: string;
    svgIcon: JSX.Element;
    features: any | { label: string; value?: string };
  }
export const PricingData: PriceCardData[] = [
  {
    title: "Individuals",
...
export const YearData: PriceCardData[] = [
    {
      title: "Individuals",
      description: "Perfect for solo users who need essential features to get started efficiently.",
      price: "$99.99",
