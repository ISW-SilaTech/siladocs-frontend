...
const CustomReviews: CustomReview[] = [
    {
        ...
        description: "Las plantillas personalizables y la interfaz clara e intuitiva facilitan el diseño de recursos creativos. Esto ha mejorado la eficiencia de nuestro equipo y nos ha permitido cumplir plazos ajustados con facilidad.",
        name: "Clara Johnson",
