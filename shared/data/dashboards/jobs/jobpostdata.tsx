...
export const Employeesname:SelectType[] = [
...
export const CountrySelect:SelectType[] = [
...
export const WorkSelect:SelectType[] = [
    {value:'0 - 1 Years', label:'0 - 1 Years'},
    {value:'1 - 3 Years', label:'1 - 3 Years'},
    {value:'3 - 5 Years', label:'3 - 5 Years'},
]
export const JobSelect:SelectType[] = [
...
export const PrioritySelect:SelectType[] = [
    {value:'Normal', label:'Normal'},
    {value:'Urgent', label:'Urgent'},
]
export const Vacancieselect:SelectType[] = [
    {value:'10', label:'10'},
    {value:'20', label:'20'},
    {value:'30', label:'30'},
    {value:'40', label:'40'},
...
export const Genderselect:SelectType[] = [
    {value:'No Preferences', label:'No Preferences'},
    {value:'Male Only', label:'Male Only'},
    {value:'Female Only', label:'Female Only'},
]
export const Languagesselect:SelectType[] = [
    {value:'English', label:'English'},
    {value:'French', label:'French'},
    {value:'Arabic', label:'Arabic'},
    {value:'Hindi', label:'Hindi'},
]
export const Qualificationselect:SelectType[] = [
