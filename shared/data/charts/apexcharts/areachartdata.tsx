...
export const Areabasicseries = [{
	name: "STOCK ABC",
	data: series.monthDataSeries1.prices
}]
export const Areabasicoptions = {
	chart: {
		type: "area",
		height: 320,
		zoom: {
...
export const Areasplineoptions = {
	chart: {
		height: 320,
		type: "area",
		events: {
...
export const Areagithuboptions = {
	chart: {
		id: "chartyear",
		type: "area",
		height: 160,
		...
		events: {
			mounted: function (chart: any) {
				const commitsEl = slideArrow(".cmeta span.commits");
...
//Stacked Area Chart
const generateDayWiseTimeSeries = function (baseval: number, count: number, yrange: { min: any; max: any; }) {
	let i = 0;
	const series: any[] = [];
	while (i < count) {
		const x = baseval;
