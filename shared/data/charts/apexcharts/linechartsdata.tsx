...
export const Linedataoptions = {
  ...
  title: {
    text: 'Average Peak and Low Temperature',
    align: 'left',
    style: {
      fontSize: '13px',
      fontWeight: 'bold',
...
export const Linezoomseries = [{
  name: "XYZ MOTORS",
  data: dates
}]
export const Linezoomoptions = {
  chart: {
    type: "area",
    stacked: false,
    height: 320,
...
export const Lineannotationseries = [{
  data: series.monthDataSeries2.prices
}]
export const Lineannotationoptions = {
  colors: ["#4767ED"],
  chart: {
    height: 320,
    type: 'line',
...
export const Linegardientoptions = {
  chart: {
    height: 320,
    type: "line",
    events: {
  ...
  xaxis: {
    ...
    tickAmount: 10,
    labels: {
      formatter: function (_value: any, _timestamp: any, opts: { dateFormatter: (arg0: Date, arg1: string) => any; }) {
...
function getDayWiseTimeSeries(baseval: number, count: number, yrange: { min: number; max: number; }) {
  var i = 0;
  while (i < count) {
    var x = baseval;
...
export const Linerealseries = [{
  data: data.slice()
}]
export const Linerealoptions = {
  chart: {
    id: 'dynamic-chart',
    height: 320,
    type: 'line',
