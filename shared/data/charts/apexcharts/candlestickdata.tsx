...
export const Candsyncedseries = [{
	data: seriesData
}]
export const Candsyncoptions = {
	chart: {
		type: 'candlestick',
		height: 215,
		id: 'candles',
...
export const CandseriesBar = [{
	name: 'volume',
	data: seriesDataLinear
}]
export const CandeoptionsBar = {
	chart: {
		height: 120,
		type: 'bar',
		brush: {
...
export const Candaxisseries = [{
	data: seriesData1
}]
export const Candaxisoptions = {
	chart: {
		events: {
			mounted: (chart: { windowResizeHandler: () => void; }) => {
				chart.windowResizeHandler();
