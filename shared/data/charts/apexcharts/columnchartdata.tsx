...
export const Stackcolumnoptions: any = {
    ...
    colors: ["#4767ED", "#ff49cd", "#fdaf22", "#32d484"],
    responsive: [{
        breakpoint: 480,
        options: {
            legend: {
...
const colors = ['#4767ED', '#e354d4', '#ff8e6f', '#0ca3e7', '#fe5454', '#0cd7b1', '#7b76fe'];
...
export const Column1options: any = {
    chart: {
        ...
        type: "bar",
        events: {
            click: function ({ _chart, _w, _e }: any) {
            },
            mounted: (chart: { windowResizeHandler: () => void; }) => {
                chart.windowResizeHandler();
            }
    ...
    colors:  ['#4767ED', '#ff49cd', '#fdaf22', '#32d484', '#00c9ff', '#ff6757', 'rgba(53, 181, 170,1)','rgb(190, 43, 235)'],
    plotOptions: {
        bar: {
            columnWidth: "45%",
            distributed: true,
