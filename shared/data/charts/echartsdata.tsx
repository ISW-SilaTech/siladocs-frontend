...
export const Stackoption = {
    ...
    color: ['#4767ED', '#ff49cd', '#fdaf22', '#32d484', '#00c9ff', '#ff6757', 'rgba(53, 181, 170,1)',]
};

//Stacked Area Chart
export const Stackareaseries = [
    {
        name: 'Email',
        type: 'line',
        stack: 'Total',
...
export const Pieoption = {
    ...
    color: ["rgb(152, 95, 253)", "#35bdaa", "#ffb748", "#e6533c", "#49b6f5"]
};

//Doughnut Chart
export const Doughnutseries = [
    {
        name: 'Access From',
        type: 'pie',
        radius: ['40%', '70%'],
...
export const Heatseries = {
    type: 'heatmap',
    coordinateSystem: 'calendar',
    data: getVirtulData('2016')
}
export const Heatoption = {
    title: {
        top: 30,
        left: 'center',
