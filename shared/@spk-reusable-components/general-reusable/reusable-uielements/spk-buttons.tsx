...
const SpkButton: React.FC<Buttontypes> = ({ Buttonvariant, Style, Buttontype, Customclass, children, bsPrefix, Role, as, Size, Active, Expand, Navigate, Disabled, Id, onClickfunc, onChangefunc, Buttontoggle, Buttonlabel, Buttondismiss, Buttoncontrols, Value, Tabindex, Buttontarget, onClick, ...props }) => {
  return (
    <Fragment>
      <Button
        type={Buttontype}
